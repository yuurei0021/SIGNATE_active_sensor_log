...
4. **実害**: 予測クラスは依然として正しく、Public LBでも100%達成
...
### 推奨モデル: **改善版（20251120_07）**

**推奨理由:**
1. **OOF scoreが優秀**: 0.9988 vs 0.9950 (+0.0038)
   - Private LBではOOF scoreが高いモデルが有利
2. **Stairs予測の安定性**: 7件の低確信度を完全に解消
3. **Public LBで完璧**: 両モデルとも100%だが、改善版の方がrobust
4. **Walking問題は限定的**:
   - たった1件のみ影響
   - 予測クラスは正しい
   - 62.13%でも十分高い確信度
...
### リスク管理
**両方の予測ファイルを保持**し、Private LB公開後に最終判断できるようにする：
- 第一候補: 20251120_07_stairs_improvement
- バックアップ: 20251120_05_baseline_lightgbm
